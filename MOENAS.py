...
def evaluate_accuracy(x):
    ...
    train_data = LSM_state_vector_generate(is_trained=1)
    ...
    test_data = LSM_state_vector_generate(is_trained=0)
...
def LSM_state_vector_generate(is_trained):
